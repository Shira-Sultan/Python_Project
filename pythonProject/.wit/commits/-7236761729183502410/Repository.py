...
class Repository:
    ...
    #
    #     folders = [f for f in os.listdir(self.repo_path) if os.path.isdir(os.path.join(self.repo_path, f))]
    #     if not folders:
    #         print(Fore.RED + "No folders found in the commiting path")
    #         return
    #
    #     # folders = sorted(folders, key=lambda f: os.path.getmtime(os.path.join(self.repo_path, f)))
    #     # last_commit = folders[-1]
    #     #
    #     # folder_to_zip = os.path.join(self.repo_path, last_commit)
    #
    #     commits_path = os.path.join(self.repo_path, '.wit', 'commits')
    #     folders = [f for f in os.listdir(commits_path) if os.path.isdir(os.path.join(commits_path, f))]
    #
